...
namespace Tap.Solid.Srp
{
    public class Student
    {
        ...
        private readonly Email_Validator emailValidatorObject;
        private readonly StudentRepository studentRepoObject;
        private readonly SendMail sendMailObject;
        public Student()
        {
            emailValidatorObject.email = Email;
            sendMailObject = new SendMail(this.Email);
            studentRepoObject = new StudentRepository();
        }
        public string AddStudent()
        {
            if (emailValidatorObject.Is_Email_Valid())
                return "cc";
